...
enum CP_BLEND_MODE		// Processing Equivalent Names
{
	...
	CP_BLEND_MIN,		// LIGHTEST
	CP_BLEND_MAX,		// DARKEST
};
...
// Set the color blend mode for rendering (USE: CP_BLEND_MODE values above, default is alpha blending)
DLL_EXPORT void blendMode(int blend_mode);
