...
// Returns the change in y of the mouse Wheel if it is scrolled
DLL_EXPORT float mouseWheel();

// Sets the ESCAPE key to exit the program (TRUE, default) or not (FALSE)
DLL_EXPORT void setExitOnEscape(int exit);
